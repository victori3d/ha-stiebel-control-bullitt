...
void publishDate()
{
    ...
    {
        ESP_LOGW("publishDate()", "Invalid year: %d", ijahr);
        return; // Ungültiges Jahr, Datum nicht veröffentlichen
    }
    ...
    {
        ESP_LOGW("publishDate()", "Invalid month: %d", imonat);
        return; // Ungültiger Monat, Datum nicht veröffentlichen
    }
    ...
    {
        ESP_LOGW("publishDate()", "Invalid day: %d", itag);
        return; // Ungültiger Tag, Datum nicht veröffentlichen
    }

    // Wenn Jahr, Monat und Tag gültig sind, Datum veröffentlichen
...
void publishTime()
{
    ...
    {
        ESP_LOGW("publishTime()", "Invalid hour: %d", istunde);
        return; // Ungültige Stunde, Zeit nicht veröffentlichen
    }
    ...
    {
        ESP_LOGW("publishTime()", "Invalid minute: %d", iminute);
        return; // Ungültige Minute, Zeit nicht veröffentlichen
    }
    ...
    {
        ESP_LOGW("publishTime()", "Invalid second: %d", isekunde);
        return; // Ungültige Sekunde, Zeit nicht veröffentlichen
    }

    // Wenn Stunde, Minute und Sekunde gültig sind, Zeit veröffentlichen
